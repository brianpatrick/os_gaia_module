#Code from El Badry Comoving Stars Paper smushed together to run on Vanir
...
#The following comment informed the devisement of el_badry_query.py; run that code to run the query
